    ...
    static class Scripting
    {
        ...
        public static void CreateNew(string CmdName)
        {
            ...
            sw.Write(
                ...
                Environment.NewLine +
                "\tUse this as a basis for custom commands implemented via the MCSong scripting framework." + Environment.NewLine +
                ...
                "// As a note, MCSong is designed for .NET 3.5." + Environment.NewLine +
        ...
        /// </summary>
        /// <param name="name">String to convert to an MCSong class name.</param>
