    ...
    public static class Program
    {
        ...
        public static void UpdateCheck(bool wait = false, Player p = null)
        {
            ...
            Thread updateThread = new Thread(new ThreadStart(delegate
            {
                ...
                try
                {
                    if (Client.DownloadString("http://dl.dropbox.com/u/65199079/MCSong/text/curversion.txt") != Server.Version)
                    {
        ...
        public static void PerformUpdate(bool oldrevision)
        {
            try
            {
                ...
                {
                    WebClient client = new WebClient();
                    Server.selectedrevision = client.DownloadString("http://dl.dropbox.com/u/65199079/MCSong/text/curversion.txt");
                    client.Dispose();
                }
