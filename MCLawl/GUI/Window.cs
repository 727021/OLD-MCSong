...
namespace MCSong.GUI
{
    public partial class Window : Form
    {
      ...
      /*     if (!Minimized)
        ...
        {
            txtChangelog.Clear();
            txtChangelog.AppendText("Changelog for MCSong Version: " + Server.Version + Environment.NewLine);
            ...
            catch (Exception ex)
            {
                Server.ErrorLog(ex);
                txtChangelog.Clear();
                txtChangelog.AppendText(Environment.NewLine + "Changelog update failed." + Environment.NewLine + "Please put the file from http://dl.dropbox.com/u/65199079/MCSong/text/changelog.txt in the /extra/ folder, then restart the server to load the changelog.");
                return;
            }
            Server.s.Log("Changelog Loaded");
        }
        ...
        private void txtInput_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                else
                {
                    ...
                    Server.s.LogPublic("Console: " + txtInput.Text);
        ...
        {
            DialogResult dr = MessageBox.Show("Are you sure you want to shut down the server?\r\nAll connections will break!", "Shutdown?", MessageBoxButtons.YesNo);
        ...
        private void txtInputAdmin_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if ((txtInputAdmin.Text == null) || (txtInputAdmin.Text.Trim() == "")) { return; }
        ...
        private void txtInputOp_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if ((txtInputOp.Text == null) || (txtInputOp.Text.Trim() == "")) { return; }
        ...
        private void txtInputPublic_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if ((txtInputPublic.Text == null) || (txtInputPublic.Text.Trim() == "")) { return; }

                Player.GlobalMessage("Console [&a" + Server.ZallState + Server.DefaultColor + "]: &f" + newtext);
                Server.s.LogPublic("Console: " + newtext);
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Server.maintenanceMode = checkBox1.Checked;
            Server.Maintenance();
        }
        ...
        {
            Server.consoleSound = checkBox2.Checked;
        }
    }
}
